...
class BPFMonitoringClient:
    def __init__(self):
        ...
        self.disk_read_bytes = self.b.get_table("disk_read_bytes")
        self.disk_write_bytes = self.b.get_table("disk_write_bytes")
        self.net_recv = self.b.get_table("net_recv")
        self.net_send_packets = self.b.get_table("net_send_packets")
        self.net_recv_packets = self.b.get_table("net_recv_packets")
    ...
    def get_process_list(self):
        ...
        for table in [
            ...
            self.net_recv,
            self.net_send_packets,
            self.net_recv_packets,
        ]:
        ...
        for pid in to_remove:
            ...
            self.safe_remove_pid(self.disk_read_bytes, key, "disk_read_bytes")
            self.safe_remove_pid(self.disk_write_bytes, key, "disk_write_bytes")
            self.safe_remove_pid(self.net_recv, key, "net_recv")
            self.safe_remove_pid(self.net_send_packets, key, "net_send_packets")
            self.safe_remove_pid(self.net_recv_packets, key, "net_recv_packets")
        ...
        for pid in pids:
            ...
            proc = {
                ...
                "disk_read_bytes": self.safe_get_bpf_table(self.disk_read_bytes, key),
                "disk_write_bytes": self.safe_get_bpf_table(self.disk_write_bytes, key),
                "net_recv_bytes": self.safe_get_bpf_table(self.net_recv, key),
                "net_send_packets": self.safe_get_bpf_table(self.net_send_packets, key),
                "net_recv_packets": self.safe_get_bpf_table(self.net_recv_packets, key),

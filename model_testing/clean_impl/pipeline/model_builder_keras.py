...
class KerasModelBuilder():
    ...
    def _train(self):
        ...
        self.model.fit(self.X_train_scaled, self.y_train, epochs=self.train_epochs, 
                batch_size=self.batch_size,callbacks = [self.callbacks], verbose = 0) #validation_split=0.1) #
...
#This class is used to train, run, evaluate and save a model to disc
